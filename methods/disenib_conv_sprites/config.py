...
class ConfigTrain(CanonicalConfigTrainPyTorch):
    ...
    def _add_root_args(self):
        ...
        # Dataset
        self.parser.set(["dataset", "num_classes"], ["sprites", 8])
    ...
    def _add_tree_args(self, args_dict):
        ...
        # Others
        ################################################################################################################
        self.parser.add_argument("--style_dim",                     type=int,   default=512)
        self.parser.add_argument("--class_dim",                     type=int,   default=512)
        ...
        self.parser.add_argument("--est_thr",                       type=int,   default=5000)
        ...
        self.parser.add_argument("--eval_dis_n_samples",            type=int,   default=8)
